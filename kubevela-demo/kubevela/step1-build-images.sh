...
docker tag kv-product-cat-api:v1.0.0 kv-product-cat-api:v1.0.0-traditional
docker tag kv-product-cat-api:v1.0.0-traditional localhost:5000/kv-product-cat-api:v1.0.0-traditional

echo "  Pushing to local registry..."
docker push localhost:5000/kv-product-cat-api:v1.0.0-traditional
...
echo "  - localhost:5000/kv-product-cat-api:v1.0.0 (KubeVela)"
if [[ $REPLY =~ ^[Yy]$ ]]; then
    echo "  - localhost:5000/kv-product-cat-api:v1.0.0-traditional (Traditional)"
fi
echo ""
echo "Next steps:"
